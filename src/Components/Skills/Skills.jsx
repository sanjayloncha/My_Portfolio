  ...
  return (
    <div className="container skill mx-auto my-5"  id="skill">
      ...
      <div className="my-3 row mx-auto text-center d-flex justify-content-center align-items-center ">
        <div id="skill_card"  data-aos="fade-down" data-aos-duration="500"  data-aos-easing="ease-in-out" className="card  mx-3 my-3 border-0" style={{ maxWidth: "100px" }}>
          <img
        ...
        <div data-aos="fade-up" data-aos-duration="700"   data-aos-easing="ease-in-out"  className="card border-0  mx-3 my-3" style={{ maxWidth: "100px" }}>
          <img
        ...
        <div  data-aos="fade-down" data-aos-duration="500"   data-aos-easing="ease-in-out"  className="card border-0  mx-3 my-3" style={{ maxWidth: "100px" }}>
          <img
